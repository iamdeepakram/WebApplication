...
<link href="<?php echo base_url();?>assets/dist/css/login.css" rel="stylesheet">
  ...
  <body class="text-center">
      <form class="form-signin" method="post">
          <h1 class="display-4 "><a class="text-decoration-none" href="<?php echo $linkHome;?>">FoodShala</a></h1>
          <h4>Restaurent</h4>
  ...
  <p class="mt-5 mb-3 text-muted">Register Restaurent to FoodShala <a type="button" class="btn btn-link" href="<?php echo $linkRegisterRestaurent; ?>"> Create Account</a></p>
</form>
</body>
</html>
