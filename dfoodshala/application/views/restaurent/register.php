...
<link href="<?php echo base_url();?>assets/dist/css/login.css" rel="stylesheet">
  ...
  <label for="inputFName" class="sr-only">Restaurent Name</label>
  <input type="text" name="restaurent_name" id="inputFName" class="form-control" placeholder="Restaurent Name" required autofocus>
  ...
  <input type="text" name="last_name" id="inputFName" class="form-control" placeholder="Last Name" required autofocus>

  <label for="inputFName" class="sr-only">Phone</label>
  <input type="number" name="phone" id="inputFName" class="form-control" placeholder="Phone" required autofocus>
