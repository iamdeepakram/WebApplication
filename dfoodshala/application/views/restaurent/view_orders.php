...
<link href="<?php echo base_url();?>assets/dist/css/dashboard.css" rel="stylesheet">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3 text-center" href="">Food Shala</a>
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link " href="<?php echo $linkDashBoardRestaurent;?>">
              <span data-feather="home"></span>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="<?php echo $linkViewOrdersRestaurent;?>">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          <tbody>
            <?php var_dump($RestaurentOrders);?>
            <?php if (!empty($RestaurentOrders)){?>
                <?php foreach ($RestaurentOrders as $key => $value) : ?>
                      <tr>
                        <td></td>
